import { Globe, Headset, LogIn, UserRoundPlus, Menu} from "lucide-react";
...
function Header() {
  return (
    <header className="text-black flex justify-between lg:justify-around items-center py-4 container mx-auto">
      ...
      <nav className="hidden lg:flex justify-center items-center gap-3 font-normal">
        <Link href="">Home</Link>
        <Link href="">Blog</Link>
        <Link href="">FAQs</Link>
